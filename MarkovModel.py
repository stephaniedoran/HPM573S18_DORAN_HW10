...
class PatientCostUtilityMonitor:
    ...
    def update(self, k, current_state, next_state):
        ...
        # if stroke occurred
        if current_state is P.HealthStats.STROKE:
...
class CohortOutputs:
    def __init__(self, simulated_cohort):
        ...
        # survival curve
        self._survivalCurve = PathCls.SamplePathBatchUpdate('Population size over time',
                                                            id, simulated_cohort.get_initial_pop_size())
